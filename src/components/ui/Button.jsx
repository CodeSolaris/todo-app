...
export const Button = ({
  ...
  const baseStyles =
    "cursor-pointer transition-colors duration-300 flex items-center justify-center rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-1 disabled:opacity-50 disabled:cursor-not-allowed";

  const variants = {
    primary:
      "bg-btn-light hover:bg-btn-light-hv dark:bg-btn-dark dark:hover:bg-btn-dark-hv text-white px-4 py-2",
    secondary:
